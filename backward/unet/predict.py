...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', '-i', type=str, default='/data/lifuwei/SPA_data/EMPIAR-LFW/10025/central_crop', help='raw_mrc_path')
    parser.add_argument('--out_path', '-o', type=str, default='/data/lifuwei/SPA_data/EMPIAR-LFW/10025/rightwithbig', help='save_path')
    parser.add_argument('--model_path', '-m', type=str, default='/data/lifuwei/small_protein/code/source_code4/backward/model/28RIGHT.pth', help='model')
    ...
    parser.add_argument('--log_dir', '-l', type=str, default='/nas_volume1/lifuwei_temp/source_code4/backward/unet/.log', help='log file directory')
