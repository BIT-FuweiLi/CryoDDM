...
python forward/forward_process_dual_norand.py -np /storage/wanxiaohua/lfw/small_protien/diffuse_model/temp_data/10025_real/real_noise/ \
 -ip /storage/wanxiaohua/lfw/small_protien/diffuse_model/temp_data/10025/normal/ \
 -op /storage/zhuxu/lfw/small_protien2/dual_data/10025/small_compare_100/norand_s5/
